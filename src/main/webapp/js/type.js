...
function typeInforShow(page){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/sourceType/selectAllSourceType",
		data:{
...
function typeInforSearch(page){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/sourceType/selectSourceTypeByName",
		data:{
...
function AddtypeInfor(){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/sourceType/insertSourceType",
		data:{
			name:submit
		},
		dataType:"json",
...
function ChangetypeInfor(){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/sourceType/updateSourceType",
		data:{
...
$(function(){
	$(".infor_tab02").on("click",".delType",function(){
		...
		function typeInforDel(typeId){
			...
			$.ajax({
				type:"post",
				url:"http://localhost:8080/sourceType/deleteSourceTypeById",
				data:{
					id:typeId,
				} ,
				dataType:"json",
