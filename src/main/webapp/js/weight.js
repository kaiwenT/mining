...
function weightInforShow(page){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/weight/selectAllWeight",
		data:{
...
function weightInforSearch(page){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/weight/selectByCondition",
		data:{
			name:$("#name").val(),
			weight:$("#weight").val(),
			start:(parseInt(3*page-3)),
...
function addWeight(){
	$.ajax({
		type:"post",
		url:"http://localhost:8080/weight/insertWeight",
		data:{
			name:$("#add_type").val(),
...
function weightInforChange(){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/weight/updateWeight",
		data:{
			id:newId,
...
$(function(){
	$(".infor_tab02").on("click",".delWeight",function(){
		...
		function weightInforDel(weight_id){
			...
			$.ajax({
				type:"post",
				url:"http://localhost:8080/weight/deleteWeight",
				data:{
					weightId:weight_id,
				} ,
				dataType:"json",
