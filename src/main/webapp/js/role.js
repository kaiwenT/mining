...
function roleInforShow(page){
	...
	$.ajax({
		type:"post",
		url:"http://182.140.244.198:8080/role/selectAllRole",
		data:{
...
function roleInforSearch(page){
	...
	$.ajax({
		type:"post",
		url:"http://182.140.244.198:8080/role/selectOneRoleInfo",
		data:{
			roleName:roleInfo,
...
function addRoleInfo(){
	...
	$.ajax({
		type:"post",
		url:"http://182.140.244.198:8080/role/insertRoleInfo",
		data:{
...
function changeRole(){
	...
	$.ajax({
		type:"post",
		url:"http://182.140.244.198:8080/role/updateRoleInfo",
		data:{
			roleId:newId,
...
$(function(){
	$(".infor_tab02").on("click",".delRole",function(){
		...
		function roleInforDel(role_id){
			$.ajax({
				type:"post",
				url:"http://182.140.244.198:8080/role/deleteRoleInfoById",
				data:{
					roleId:role_id
				} ,
				dataType:"json",
