...
function roleInforSearch(page){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/role/selectOneRoleInfo",
		data:{
			roleName:roleInfo,
...
function addRoleInfo(){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/role/insertRoleInfo",
		data:{
...
function changeRole(){
	...
	$.ajax({
		type:"post",
		url:"http://localhost:8080/role/updateRoleInfo",
		data:{
			roleId:newId,
...
$(function(){
	$(".infor_tab02").on("click",".delRole",function(){
		...
		function roleInforDel(role_id){
			$.ajax({
				type:"post",
				url:"http://localhost:8080/role/deleteRoleInfoById",
				data:{
					roleId:role_id
				} ,
				dataType:"json",
